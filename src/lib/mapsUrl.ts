...
/* Hoisted out of dashboard/page.tsx, which is a page rather than a module other
   screens should be importing from. The group page links the winner and every
   shortlist row to Maps, so both need it. */
 ...
 * Falls back to coordinates for the rows that have no address. */
